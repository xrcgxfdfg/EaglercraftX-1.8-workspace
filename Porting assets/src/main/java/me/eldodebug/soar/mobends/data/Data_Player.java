package me.eldodebug.soar.mobends.data;
...
public class Data_Player extends MoBends_EntityData{
				...
				if(this.currentAttack == 0){
					...
					if(this.ticksAfterPunch < 15.0f){
						if(this.currentAttack == 1) this.currentAttack = 2;
							...
							this.currentAttack = (!thirdSwordAttack || this.getEntity().isRiding()) ? 1 : 3;
						}
