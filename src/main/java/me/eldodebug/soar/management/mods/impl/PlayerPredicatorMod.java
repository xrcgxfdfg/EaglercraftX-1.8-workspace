	...
	public void onReceivePacket(EventReceivePacket event) {
		...
		if(packet instanceof S14PacketEntity) {
            ...
            if (s14PacketEntity.getEntityId() == target.getEntityId()) {
                realTargetPosition.x += s14PacketEntity.getEntityId() / 32D;
                realTargetPosition.y += s14PacketEntity.getEntityId() / 32D;
                realTargetPosition.z += s14PacketEntity.getEntityId() / 32D;
            }
