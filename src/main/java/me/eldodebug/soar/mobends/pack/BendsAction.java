...
public class BendsAction {
	...
	public MoBendsEnumAxis axis;
	public float smooth;
	public EnumModifier mod;
	public float visual_DeletePopUp;
	
	public BendsAction(String argAnim,String argModel,EnumBoxProperty argProp,MoBendsEnumAxis argAxis,float argSmooth,float argNumber){
		this.anim = argAnim;
		this.model = argModel;
		this.prop = argProp;
		this.axis = argAxis;
