...
public class Render3DUtils {
    ...
    public static void drawTargetIndicator(Entity entity, double rad, Color color) {
        ...
        double y = (entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * mc.timer.renderPartialTicks - mc.getRenderManager().viewerPosY) + Math.sin(System.currentTimeMillis() / 2E+2) + 1;
